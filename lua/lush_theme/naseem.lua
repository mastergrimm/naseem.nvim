...
local theme = lush(function(injected_functions)
	...
	return {
		...
		DiagnosticVirtualTextInfo({ fg = "#6ca0a2", bg = "#151e1c" }), -- Used for "Info" diagnostic virtual text.
		DiagnosticVirtualTextHint({ fg = "#6ca0a2", bg = "#151e1c" }), -- Used for "Hint" diagnostic virtual text.
