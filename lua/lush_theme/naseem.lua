...
local theme = lush(function(injected_functions)
	...
	return {
		...
		DiagnosticVirtualTextInfo({ fg = "#70b4b7", bg = "#10201d" }), -- Used for "Info" diagnostic virtual text.
		DiagnosticVirtualTextHint({ fg = "#70b4b7", bg = "#10201d" }), -- Used for "Hint" diagnostic virtual text.
